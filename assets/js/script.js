(function($) {
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2025/04/27 18:00:00', function(event) {
    ...
    if ($("#rsvp-form").length) {
        $("#rsvp-form").validate({
            ...
            messages: {
                name: "Coloca tu nombre aquí",
                email: "Coloca tu email",
                guest: "Cuantas personas son",
                events: "A que eventos asistiras"
            },
    ...
    // Ensure music plays after user interaction (for autoplay restrictions)
